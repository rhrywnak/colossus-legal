...
npm run dev -- --host 0.0.0.0 --port 5473
...
# - npm run dev, load http://localhost:5473
...
curl -s http://localhost:3403/health  # Backend health
curl -I http://localhost:5473         # Frontend dev server
