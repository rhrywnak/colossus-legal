...
export function optionsFixture(): AllegationOptions {
  ...
  link_typeahead_intro: "This statement is not linked to anything.",
      ...
      include_picker_label: "Include under:",
      include_picker_choose_prompt: "Choose an accusation…",
      include_picker_helps_us_label: "Helps us",
      include_picker_helps_them_label: "Helps them",
