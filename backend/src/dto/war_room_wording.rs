...
impl From<&WarRoomWording> for WarRoomWordingDto {
    fn from(w: &WarRoomWording) -> Self {
        Self {
            ...
            card_talking_points_label: w.card_talking_points_label.clone(),
            card_watch_items_label: w.card_watch_items_label.clone(),
            card_deck_label: w.card_deck_label.clone(),
            card_deck_template: w.card_deck_template.clone(),
            card_deck_none: w.card_deck_none.clone(),
            card_answered_count_template: w.card_answered_count_template.clone(),
            card_answered_split_template: w.card_answered_split_template.clone(),
            card_changed_template: w.card_changed_template.clone(),
            card_up_to_date: w.card_up_to_date.clone(),
            card_open_action: w.card_open_action.clone(),
