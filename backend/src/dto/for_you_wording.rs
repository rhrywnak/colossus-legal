...
impl ForYouWordingDto {
    ...
    pub fn from_block(w: &ForYouWording) -> Self {
        Self {
            ...
            deck_body_template: w.deck_body_template.clone(),
            deck_body_one: w.deck_body_one.clone(),
            deck_byline_template: w.deck_byline_template.clone(),
            body_reply_template: w.body_reply_template.clone(),
