...
//!
//! What this module owns: composing display-ready human content — the date
//! label, the authored tag, and the C1 identity block. The validation law lives
//! in `services::scenario_augmentation`; the §8 write-path invariants live
//! beside the tables they protect; the route SHAPE lives beside the routes, in
//! `scenario_augmentation_tests`.
