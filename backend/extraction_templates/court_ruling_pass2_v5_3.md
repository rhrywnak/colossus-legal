...
-->
# Court Ruling Relationship Extraction — Pass 2: Relationships Only (v5.3)
...
A single finding may carry CHARACTERIZES to **both** a Party and an Allegation — they answer different questions ("who was labelled?" and "which claim does the labelling touch?"). It is not either/or.
