...
- `statement_date`: Date the affidavit was signed/notarized (same for all Evidence entities from one affidavit)
- `event_date`: Date of the event being described, if the statement mentions when something happened
- `pattern_tags`: Comma-separated trial-prep patterns if applicable: coordination, selective_enforcement, disparagement, financial_misconduct, secrecy, elder_abuse, competence, undue_influence, coercion
